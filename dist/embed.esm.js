/* birdfyi-embed v1.0.0 | MIT | https://widget.birdfyi.com */
...
(function bootstrap() {
  const config = '{"site":"birdfyi","name":"BirdFYI","domain":"birdfyi.com","accent":"#10B981","attribute":"data-birdfyi","apiBase":"https://birdfyi.com/api/v1/","searchPath":"/search/","entityName":"Birds","entitySlug":"birds"}';
...
function makeWidgetElement(widgetType, initFn, domainAttrs) {
  ...
  return class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._syncDataAttrs();
      initFn(this, '{"site":"birdfyi","name":"BirdFYI","domain":"birdfyi.com","accent":"#10B981","attribute":"data-birdfyi","apiBase":"https://birdfyi.com/api/v1/","searchPath":"/search/","entityName":"Birds","entitySlug":"birds"}');
    }
    ...
    _syncDataAttrs() {
      const attrKey = '{"site":"birdfyi","name":"BirdFYI","domain":"birdfyi.com","accent":"#10B981","attribute":"data-birdfyi","apiBase":"https://birdfyi.com/api/v1/","searchPath":"/search/","entityName":"Birds","entitySlug":"birds"}'.attribute.replace("data-", "");
...
(function registerElements() {
  ...
  const site = '{"site":"birdfyi","name":"BirdFYI","domain":"birdfyi.com","accent":"#10B981","attribute":"data-birdfyi","apiBase":"https://birdfyi.com/api/v1/","searchPath":"/search/","entityName":"Birds","entitySlug":"birds"}'.site;
  const defs = [
